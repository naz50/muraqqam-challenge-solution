# -*- coding: utf-8 -*-
# ============================================================
#  Muraqqam Challenge — v21 (جولة التسميات الزائفة الثانية)
#  المطلوب: train.csv و test.csv و artifacts.npz (ذخيرة v17)
#
#  يعيد تدريب أقوى عائلتين بتسميات زائفة من الخزّان الخماسي الحالي
#  (أقوى بكثير من تسميات الجولة الأولى) ويضيفهما كمكونين جديدين:
#    AR4 = AraBERT-base  8 حقب (~1.5-2 ساعة على T4)
#    CA2 = CAMeLBERT-MSA 8 حقب (~1.5-2 ساعة على T4)
