# -*- coding: utf-8 -*-
# ============================================================
#  Muraqqam Challenge — v23 (النهائي الشامل: تدريب + دمج + تسليم في تشغيلة واحدة)
#  المطلوب: train.csv و test.csv و artifacts.npz (ذخيرة v17)
#
#  تشغيلة واحدة تفعل كل شيء (~3-4 ساعات على T4، أسرع على 2xT4):
#    1) AR4 = AraBERT-base  بتسميات زائفة من الخزّان الخماسي (8 حقب)
#    2) CA2 = CAMeLBERT-MSA بتسميات زائفة (8 حقب)
#    3) ML1 = AraBERT-base برأس multi-label (سبعة sigmoid، 6 حقب)
#    4) دمج الكل بطبقة Stacking (لوجستي لكل رمز + ميزات الجيران)
#    5) توليد submission.csv جاهز للتسليم + حفظ الذخيرة الكاملة
...
CONF = 0.90
TRAIN_AR4 = True   # AraBERT-base بتسميات الجولة الثانية
TRAIN_CA2 = True   # CAMeLBERT بتسميات الجولة الثانية
TRAIN_ML  = True   # AraBERT-base برأس multi-label
NUM_EPOCHS_ML = 1 if FAST_RUN else 6

MODEL_AR4 = 'aubmindlab/bert-base-arabertv02'
MODEL_CA2 = 'CAMeL-Lab/bert-base-arabic-camelbert-msa'
...
ADD = []
if TRAIN_AR4: ADD.append(('ar4', MODEL_AR4, 1200, dict(bs=16, lr=3e-5, epochs=8)))
if TRAIN_CA2: ADD.append(('ca2', MODEL_CA2, 1300, dict(bs=16, lr=3e-5, epochs=8)))
