# -*- coding: utf-8 -*-
# ============================================================
#  Muraqqam Challenge — v33 (كود واحد سريع: ~2-3 ساعات، مدخلات المسابقة فقط)
#  المطلوب: train.csv و test.csv و artifacts.npz (ذخيرة v17)
#
#  كود واحد مكتفٍ بذاته وسريع: مدخلاته بيانات المسابقة فقط (train + test).
#  لا Datasets ولا ذخائر ولا ملفات خارجية. Save & Run All مرة واحدة.
#
#  4 مكونات (أعلى قيمة مقابل الوقت) + Stacking:
#    1) ar2 = AraBERT-base (4 طيات، 6 حقب) بلا تسميات زائفة
#    -> تسميات زائفة (ثقة >= 0.90)
#    2) ca1 = CAMeLBERT-MSA (4 طيات، 6 حقب)
#    -> تسميات زائفة أقوى
#    3) ag1 = AraBERT + augmentation (جمل معاد تركيبها + تكثيف ! و ؛) — 4 طيات، 8 حقب
#    4) ml1 = AraBERT برأس multi-label (سبعة sigmoid) — 4 طيات، 6 حقب
#    ثم: Stacking (لوجستي لكل رمز + ميزات الجيران) -> submission.csv
#
#  الزمن: ~2 ساعة على T4x2 (وحتى 3 على T4 مفرد). بذور مثبتة — قابل لإعادة الإنتاج.
#  كل طية تحفظ في كاش داخل الجلسة — إعادة التشغيل لا تعيد المكتمل.
# ============================================================
